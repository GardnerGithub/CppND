...
ChatLogic::ChatLogic()
{
    ...
    // Instance is created in LoadAnswerGraphFromFile
...
ChatLogic::~ChatLogic()
{
    ...
    // No longer needed due to use of smart pointers
                ...
                if (idToken != tokens.end())
                {
                    ...
                    if (type->second == "NODE")
                    {
                        ...
                        if (newNode == _nodes.end())
                        {
                            ...
                            AddAllTokensToElement("ANSWER", tokens, *((*newNode).get())); // Use raw pointer reference
                        }
                    ...
                    if (type->second == "EDGE")
                    {
                        ...
                        if (parentToken != tokens.end() && childToken != tokens.end())
                        {
                            ...
                            (*parentNode)->AddEdgeToChildNode(std::move(edge)); // Transfer ownership of edge
                        }
